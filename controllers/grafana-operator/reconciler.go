...
func (r *GrafanaOperatorReconciler) hasSecurityContextConstraintsAPI() bool {
...
func (r *GrafanaOperatorReconciler) uninstallGrafanaDashboards(cr *monv1.PlatformMonitoring) {
	for _, mResource := range utils.GrafanaKubernetesDashboardsResources {
		if err := r.deleteGrafanaDashboard(mResource, cr); err != nil {
			r.Log.Error(err, "Can not delete GrafanaDashboard")
		}
...
func (r *GrafanaOperatorReconciler) uninstall(cr *monv1.PlatformMonitoring) {
