...
func etcdServiceMonitor(cr *monv1.PlatformMonitoring, etcdServiceNamespace string, isOpenshiftV4 bool) (*promv1.ServiceMonitor, error) {
...
func etcdSecret(cr *monv1.PlatformMonitoring) (*corev1.Secret, error) {
