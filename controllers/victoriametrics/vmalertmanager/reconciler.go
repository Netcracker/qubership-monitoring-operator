...
func (r *VmAlertManagerReconciler) Run(ctx context.Context, cr *v1beta1.PlatformMonitoring) error {
...
func (r *VmAlertManagerReconciler) uninstall(cr *v1beta1.PlatformMonitoring) {
	if utils.PrivilegedRights {
