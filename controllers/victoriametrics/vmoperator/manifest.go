...
func vmOperatorRole(cr *monv1.PlatformMonitoring) (*rbacv1.Role, error) {
	role := rbacv1.Role{}
...
func vmOperatorServiceAccount(cr *monv1.PlatformMonitoring) (*corev1.ServiceAccount, error) {
...
func vmOperatorRoleBinding(cr *monv1.PlatformMonitoring) (*rbacv1.RoleBinding, error) {
...
func vmOperatorClusterRole(cr *monv1.PlatformMonitoring) (*rbacv1.ClusterRole, error) {
...
func vmOperatorClusterRoleBinding(cr *monv1.PlatformMonitoring) (*rbacv1.ClusterRoleBinding, error) {
...
func vmKubeletService(cr *monv1.PlatformMonitoring) (*corev1.Service, error) {
	service := corev1.Service{}
...
func vmOperatorServiceMonitor(cr *monv1.PlatformMonitoring) (*promv1.ServiceMonitor, error) {
