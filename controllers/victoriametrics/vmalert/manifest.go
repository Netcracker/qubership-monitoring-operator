...
func vmAlertServiceAccount(cr *v1beta1.PlatformMonitoring) (*corev1.ServiceAccount, error) {
...
func vmAlertClusterRole(cr *v1beta1.PlatformMonitoring, hasPsp, hasScc bool) (*rbacv1.ClusterRole, error) {
...
func vmAlertClusterRoleBinding(cr *v1beta1.PlatformMonitoring) (*rbacv1.ClusterRoleBinding, error) {
...
func vmAlert(r *VmAlertReconciler, cr *v1beta1.PlatformMonitoring) (*vmetricsv1b1.VMAlert, error) {
	var err error
...
func vmAlertIngressV1beta1(cr *v1beta1.PlatformMonitoring) (*networkingv1beta1.Ingress, error) {
	...
	if cr.Spec.Victoriametrics != nil && cr.Spec.Victoriametrics.VmAlert.Ingress != nil && cr.Spec.Victoriametrics.VmAlert.Ingress.IsInstall() {
		...
		rule := networkingv1beta1.IngressRule{Host: cr.Spec.Victoriametrics.VmAlert.Ingress.Host}
...
func vmAlertIngressV1(cr *v1beta1.PlatformMonitoring) (*networkingv1.Ingress, error) {
