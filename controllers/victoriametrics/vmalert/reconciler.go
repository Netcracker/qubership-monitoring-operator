...
func (r *VmAlertReconciler) Run(ctx context.Context, cr *monv1.PlatformMonitoring) error {
...
func (r *VmAlertReconciler) uninstall(cr *monv1.PlatformMonitoring) {
	if utils.PrivilegedRights {
...
func platformIsOpenShift(r *VmAlertReconciler) (bool, error) {
	if r == nil {
		return false, nil
	}
