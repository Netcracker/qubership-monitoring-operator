...
func (r *VmClusterReconciler) Run(ctx context.Context, cr *v1beta1.PlatformMonitoring) error {
...
func (r *VmClusterReconciler) uninstall(cr *v1beta1.PlatformMonitoring) {
	if utils.PrivilegedRights {
