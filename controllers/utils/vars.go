...
var (
	...
	VmKubeletServiceEndpointSliceAsset                = BasePath + "kubelet-endpointslice.yaml"
	...
	VmKubeSchedulerServiceEndpointSliceAsset          = BasePath + "kube-scheduler-endpointslice.yaml"
	...
	VmKubeControllerManagerServiceEndpointSliceAsset  = BasePath + "kube-controller-manager-endpointslice.yaml"
