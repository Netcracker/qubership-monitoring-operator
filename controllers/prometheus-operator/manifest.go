...
func prometheusOperatorRole(cr *v1beta1.PlatformMonitoring) (*rbacv1.Role, error) {
	role := rbacv1.Role{}
...
func prometheusOperatorServiceAccount(cr *v1beta1.PlatformMonitoring) (*corev1.ServiceAccount, error) {
...
func prometheusOperatorRoleBinding(cr *v1beta1.PlatformMonitoring) (*rbacv1.RoleBinding, error) {
...
func prometheusOperatorClusterRole(cr *v1beta1.PlatformMonitoring) (*rbacv1.ClusterRole, error) {
...
func prometheusOperatorClusterRoleBinding(cr *v1beta1.PlatformMonitoring) (*rbacv1.ClusterRoleBinding, error) {
...
func prometheusOperatorDeployment(cr *v1beta1.PlatformMonitoring) (*appsv1.Deployment, error) {
	d := appsv1.Deployment{}
...
func prometheusOperatorService(cr *v1beta1.PlatformMonitoring) (*corev1.Service, error) {
...
func prometheusOperatorPodMonitor(cr *v1beta1.PlatformMonitoring) (*promv1.PodMonitor, error) {
