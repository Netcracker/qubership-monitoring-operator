...
{{- define "monitoring.operator.image" -}}
  ...
  {{- else -}}
    {{- print "ghcr.io/netcracker/qubership-monitoring-operator:latest" -}}
  {{- end -}}
{{- end -}}
...
{{- define "grafana.operator.image" -}}
  {{- if .Values.grafana.operator -}}
    ...
    {{- else -}}
      {{- print "quay.io/grafana-operator/grafana-operator:v5.20.0" -}}
    {{- end -}}
  {{- end -}}
{{- end -}}
...
{{- define "grafana.initContainer.image" -}}
  {{- if .Values.grafana.operator -}}
    ...
    {{- else -}}
      {{- print "ghcr.io/netcracker/qubership-grafana-plugins-init:latest" -}}
    {{- end -}}
  {{- end -}}
{{- end -}}
...
{{- define "vm.operator.image" -}}
  ...
  {{- else -}}
    {{- print "docker.io/victoriametrics/operator:v0.63.0" -}}
  {{- end -}}
{{- end -}}
...
{{- define "vm.operator.configReloader.image" -}}
  ...
  {{- else -}}
    {{- print "docker.io/victoriametrics/operator:config-reloader-v0.63.0" -}}
  {{- end -}}
{{- end -}}
...
{{- define "vm.agent.image" -}}
  ...
  {{- else -}}
    {{- print "docker.io/victoriametrics/vmagent:v1.126.0" -}}
  {{- end -}}
{{- end -}}
...
{{- define "vm.alert.image" -}}
  ...
  {{- else -}}
    {{- print "docker.io/victoriametrics/vmalert:v1.126.0" -}}
  {{- end -}}
{{- end -}}
...
{{- define "vm.auth.image" -}}
  ...
  {{- else -}}
    {{- print "docker.io/victoriametrics/vmauth:v1.126.0" -}}
  {{- end -}}
{{- end -}}
...
{{- define "vm.select.image" -}}
  ...
  {{- else -}}
    {{- print "docker.io/victoriametrics/vmselect:v1.126.0-cluster" -}}
  {{- end -}}
{{- end -}}
...
{{- define "vm.storage.image" -}}
  ...
  {{- else -}}
    {{- print "docker.io/victoriametrics/vmstorage:v1.126.0-cluster" -}}
  {{- end -}}
{{- end -}}
...
{{- define "vm.insert.image" -}}
  ...
  {{- else -}}
    {{- print "docker.io/victoriametrics/vminsert:v1.126.0-cluster" -}}
  {{- end -}}
{{- end -}}
...
{{- define "vm.single.image" -}}
  ...
  {{- else -}}
    {{- print  "docker.io/victoriametrics/victoria-metrics:v1.126.0" -}}
  {{- end -}}
{{- end -}}
...
{{- define "integrationTests.image" -}}
  ...
  {{- else -}}
    {{- print "ghcr.io/netcracker/qubership-monitoring-int-tests:latest" -}}
  {{- end -}}
{{- end -}}
