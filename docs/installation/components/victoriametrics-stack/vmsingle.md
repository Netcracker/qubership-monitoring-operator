...
| httpRoute                  | HTTPRoute allows to create Gateway API HTTPRoute for the vmsingle UI.                                                                                                                                                                       | [HTTPRouteSpec](https://gateway-api.sigs.k8s.io/reference/spec/#httproutespec)                                               |
