...
| httpRoute                     | HTTPRoute allows to create Gateway API HTTPRoute for the vmauth UI.                                                                                                                                                                                           | [HTTPRouteSpec](https://gateway-api.sigs.k8s.io/reference/spec/#httproutespec)                                               | false    |
