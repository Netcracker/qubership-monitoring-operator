...
| httpRoute                     | HTTPRoute allows to create Gateway API HTTPRoute for the vmalertmanager UI.                                                                                                                                                                                                                        | [HTTPRouteSpec](https://gateway-api.sigs.k8s.io/reference/spec/#httproutespec)                                               |
