...
| containerSecurityContext         | Holds container-level security attributes. Default for Kubernetes, `containerSecurityContext: { capabilities.drop: ALL, allowPrivilegeEscalation: false }`.                                                            | [core/v1.SecurityContext](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#securitycontext-v1-core)      |
...
| tlsConfig                        | TLS configuration for VMOperator. Must be specified if `victoriametrics.tlsEnabled` is set to `true`                                                                                                                   | [TLSConfig](../../../api/platform-monitoring.md#tlsconfig)                                                                   |
