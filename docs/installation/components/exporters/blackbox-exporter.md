...
| containerSecurityContext                            | Security Context for a container.                                                                                                                                                                                                   | [*v1.SecurityContext](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#securitycontext-v1-core) |
...
| serviceMonitor.enabled                              | If true, a ServiceMonitor is created for exporter self-metrics (`/metrics`). URL probes use Prometheus Operator `Probe` CRs, not this chart.                                                                                         | boolean                                                                                                                        |
| serviceMonitor.interval                             | Scrape interval for the self-metrics ServiceMonitor.                                                                                                                                                                                | string                                                                                                                         |
