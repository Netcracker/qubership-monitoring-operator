...
| override    | Overrides the expression, duration, severity, or annotations of built-in Prometheus rules                                                                                                                              | list[object]      |
...
prometheusRules:
  ...
  override:
      - group: SelfMonitoring
        ...
        severity: high
        annotations:
          summary: Custom notification backlog summary
          runbook_url: https://example.org/runbooks/prometheus-backlog
  labels:
